...
ActiveRecord::Schema[7.1].define(version: 2024_03_12_103717) do
  ...
  create_table "books", force: :cascade do |t|
    ...
    t.string "book_type"
    t.string "image_url"
    t.integer "thriller_score"
    t.integer "romance_score"
    t.integer "aventure_score"
    t.integer "jeunesse_score"
  end
